...
public:
    MouseEvent() : 
        window(NULL), button(NO_BUTTON), x(0), y(0), lastX(0), lastY(0), delta(0) { }

    MouseEvent(Window* window, INT button, INT x, INT y) : 
        window(window), button(button), x(x), y(y), lastX(x), lastY(y), delta(0) { }

    MouseEvent(Window* window, INT button, INT x, INT y, INT lastX, INT lastY) : 
        window(window), button(button), x(x), y(y), lastX(lastX), lastY(lastY), delta(0) { }
